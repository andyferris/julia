...
import Base: USE_BLAS64, abs, big, broadcast, ceil, conj, convert, copy, copy!,
    ...
    hcat, imag, inv, isapprox, kron, length, linearindexing, map, ndims, parent,
    power_by_squaring, print_matrix, promote_rule, real, round, setindex!, show,
    similar, size, transpose, trunc, typed_hcat
